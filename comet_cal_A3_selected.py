...
def cal_comet_raw_data(comet_name, obsdate, receiver, freq_limit):
    ...
    base_output_path = f"{my_disk}/N2024_8_selected"
...
if __name__ == "__main__":
    ...
    receiver = "UWB2"
    freq_limit_list = [[1300,1350], [1350,1450], [1630,1664], [1664,1670], [1705,1750]]
    for obs_date,freq_limit in product(obsdate, freq_limit_list):
        cal_comet_raw_data(comet_name, obs_date, receiver, freq_limit)
    
    receiver = "UWB3"
    freq_limit_list = [[1750,1800], [1975,2060],[2060,2100], [2100,2150], [2235,2325]]
    for obs_date,freq_limit in product(obsdate, freq_limit_list):
        cal_comet_raw_data(comet_name, obs_date, receiver, freq_limit)
    
    receiver = "UWB4"
    freq_limit_list = [[2600,2660], [2700,2750], [2750,2845], [2870,2940], [2960,3000], 
